...
Este comando nos crea un proyecto sobre vite y nos deja elegir la tecnologia que queramos de front, se ve lindo habria que investigarlo mas y dejar de usar webpack jeje. Vite al crear la app crea un proyecto sobre Node.js, tiene package.json ya levanta directamente godd.

**12. Tipos basicos y conceptos generales**

archivo: 

/topics/01-basic-types.ts
...
topic/06-function-destructuring.ts
